...
class SOLUTION:
    ...
    def Create_Body(self):
        ...
        #pyrosim.Send_Cube(color_code = blue_code, color_name = blue_name, name = "Torso", pos=[1,0,1.5] , size=[4, 1, .2])

        # pyrosim.Send_Joint(name = "Torso_Leg1" , parent= "Torso" , child = "Leg1" , type = "revolute", position = [0.5,0,1], jointAxis = '1 0 0', rpy = random.randint(0,3))
        ...
        if self.num_segments_1 > 0:    
            ...
            pyrosim.Send_Cube(color_code = blue_code, color_name = blue_name,name = "Leg1", pos=cube_position , size=size_dummy_1)
            self.sensor_cubes = ['Torso', 'Leg1']
            self.chosen_cubes = ['Torso','Leg1']
        ...
        if self.num_segments_2 > 0:
            ...
            pyrosim.Send_Cube(color_code = green_code, color_name = green_name,name = "Leg2", pos=cube_position , size=size_dummy)
        ...
        if self.num_segments_3 > 0:
            ...
            size_dummy_3 = np.zeros(3)
            for x in range(3):
                size_dummy_3[x] = random.uniform(0,1) * .9
            cube_position = [np.random.uniform(-1,1)*size_dummy_3[0]/2,np.random.uniform(-1,1)*size_dummy_3[1]/2,size_dummy_3[2]/2]
            pyrosim.Send_Cube(color_code = green_code, color_name = green_name,name = "Leg3", pos=cube_position , size=size_dummy_3)
            self.sensor_cubes.append('Leg3')
            self.chosen_cubes.append('Leg3')
