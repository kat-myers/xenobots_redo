...
class SOLUTION:
    ...
    def Create_Body(self):
        ...
        pyrosim.Send_Joint(name = "RightLeg_RightLowerLeg1" , parent= "RightLeg1" , child = "RightLowerLeg1" , type = "revolute", position = [1,0,0], jointAxis = "0 0 1")
        # leg relative to above joint
        pyrosim.Send_Cube(name="RightLowerLeg1", pos=[0,0,-0.5] , size=[0.2,0.2,1])      

        
        ## Right Leg 2
        pyrosim.Send_Joint(name = "Torso_RightLeg2" , parent= "Torso" , child = "RightLeg2" , type = "revolute", position = [0.5,1,1], jointAxis = "0 0 1")
        pyrosim.Send_Cube(name="RightLeg2", pos=[0.5,0,0] , size=[1,0.2,0.2])  

        # joint relative to above joint
        pyrosim.Send_Joint(name = "RightLeg_RightLowerLeg2" , parent= "RightLeg2" , child = "RightLowerLeg2" , type = "revolute", position = [1,0,0], jointAxis = "0 0 1")
        # leg relative to above joint
        ...
        pyrosim.Send_Joint(name = "LeftLeg_LeftLowerLeg1" , parent= "LeftLeg1" , child = "LeftLowerLeg1" , type = "revolute", position = [-1,0,0], jointAxis = "0 0 1")
        # cube is relative to above joint
        pyrosim.Send_Cube(name="LeftLowerLeg1", pos=[0,0,-0.5] , size=[0.2,0.2,1])        
    
        ## Left Leg 2
        # joint absolute
        pyrosim.Send_Joint(name = "Torso_LeftLeg2" , parent= "Torso" , child = "LeftLeg2" , type = "revolute", position = [-0.5,1,1], jointAxis = "0 0 1")
        # cube is relative to above joint
        pyrosim.Send_Cube(name="LeftLeg2", pos=[-0.5,0,0] , size=[1,0.2,0.2])
        
        # joint is relative to above joint
        pyrosim.Send_Joint(name = "LeftLeg_LeftLowerLeg2" , parent= "LeftLeg2" , child = "LeftLowerLeg2" , type = "revolute", position = [-1,0,0], jointAxis = "0 0 1")
        # cube is relative to above joint
    ...
    def Create_Brain(self):
       ...
       # # pyrosim.Send_Sensor_Neuron(name = 4, linkName = "RightLeg")
        ...
        pyrosim.Send_Motor_Neuron(name = 5, jointName = "Torso_LeftLeg2")
        pyrosim.Send_Motor_Neuron(name = 6, jointName = "Torso_RightLeg1")
        pyrosim.Send_Motor_Neuron(name = 7, jointName = "Torso_RightLeg2")
        pyrosim.Send_Motor_Neuron(name = 8, jointName = "LeftLeg_LeftLowerLeg1")
        pyrosim.Send_Motor_Neuron(name = 9, jointName = "LeftLeg_LeftLowerLeg2")
        pyrosim.Send_Motor_Neuron(name = 10, jointName = "RightLeg_RightLowerLeg1")
        pyrosim.Send_Motor_Neuron(name = 11, jointName = "RightLeg_RightLowerLeg2")
